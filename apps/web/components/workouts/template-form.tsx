...
export function TemplateForm({ template }: { template?: WorkoutTemplate }) {
  ...
  return (
    ...
    >
      ...
      <div className="sticky bottom-[calc(3.5rem_-_1px_+_env(safe-area-inset-bottom))] z-20 -mx-4 flex items-center justify-end gap-2 border-t bg-background/95 px-4 py-3 backdrop-blur md:bottom-0 md:-mx-6 md:px-6">
